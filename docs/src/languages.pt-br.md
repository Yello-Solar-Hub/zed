---
título: Suporte a idiomas
descrição: “Visão geral do suporte a linguagens de programação no Zed, incluindo linguagens integradas e baseadas em extensões.”
---

# Suporte a idiomas no Zed

O Zed é compatível com centenas de linguagens de programação e formatos de texto.
Algumas funcionam imediatamente, enquanto outras dependem de extensões de terceiros.

> Os que vêm incluídos por padrão, integrados nativamente ao Zed, estão marcados com \*.

## Linguagens com documentação

- [Ansible](./languages/ansible.md)
- [AsciiDoc](./languages/asciidoc.md)
- [Astro](./languages/astro.md)
- [Bash](./languages/bash.md) \*
- [Bioma](./languages/biome.md)
- [C](./languages/c.md) \*
- [C++](./languages/cpp.md) \*
...
- [Rust](./languages/rust.md) \* (O Zed foi escrito em Rust)
- [Scala](./languages/scala.md)
- [Scheme](./languages/scheme.md)
- [Script Shell](./languages/sh.md)
...
## Extensões adicionais de idiomas da comunidade
...
- [Assembleia](https://github.com/DevBlocky/zed-asm)
...
- [Plano](https://github.com/tfuxu/zed-blueprint)
...
- [Linguagem de políticas do CFEngine](https://github.com/olehermanse/zed-cfengine)
- [CSV](https://github.com/huacnlee/zed-csv)
- [Pepino/Pepininho](https://github.com/thlcodes/zed-extension-cucumber)
- [CUE](https://github.com/jkasky/zed-cue)
- [Curry](https://github.com/fwcd/zed-curry)
- [D](https://github.com/staysail/zed-d)
- [Linguagem de Marcação de Banco de Dados (DBML)](https://github.com/shuklaayush/zed-dbml)
- [Earthfile](https://github.com/glehmann/earthfile.zed)
- [Modelo EJS](https://github.com/dangh/zed-ejs)
...
- [Montagem do PICA200](https://github.com/Squareheron942/zed-pica200)
...
- [Rescrito](https://github.com/humaans/rescript-zed)
- [Roclang](https://github.com/h2000/zed-roc)
- [Ron](https://github.com/onbjerg/zed-ron)
- [Metais](https://github.com/scalameta/metals-zed)
...
- [Pergunta sobre ativistas que ficam em árvores](https://github.com/vitallium/zed-tree-sitter-query)
